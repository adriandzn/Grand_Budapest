...
<body class="bg-lightpink bg-opacity-25">
    ...
    <section class="text-white py-5"
        ...
        <div class="container py-4 ps-5">
            <div class="row">
                <div class="col">
                    <h1 class="display-3 font-title font-white fw-bold">Dining</h1>
                    <p class="lead font-white font-title">Amenities</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12">
                    <div class="row g-0 bg-white rounded-3 shadow overflow-hidden <?php echo $venueReverse[$i] ? 'flex-row-reverse' : ''; ?>">
                        ...
                        <div class="col-lg-5 p-4 p-md-5 bg-white text-dark d-flex flex-column justify-content-center">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="display-5 font-title mb-2"><?php echo $venueNames[$i]; ?></h2>
                                    <h5 class="font-body mb-1"><?php echo $venueSubtitles[$i]; ?></h5>

                                    <?php if(!empty($venueHours[$i])): ?>
                                        <p class="small text-muted fst-italic mb-4"><?php echo $venueHours[$i]; ?></p>
                                    <?php else: ?>
                                        <div class="mb-4"></div>
                                    <?php endif; ?>

                                    <p class="medium fw-normal m-0"><?php echo $venueDescriptions[$i]; ?></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row align-items-center rounded-4 px-5 py-3 bg-lightbrown">
            ...
            <div class="col-lg-7 text-center text-lg-start mb-4 mb-lg-0">
                <h2 class="h2 text-white fw-bold my-3">Ready To Experience Timeless Elegance?</h2>
