...
<body class="bg-lightpink bg-opacity-25">
    ...
    <section class="text-white py-5"
        ...
        <div class="container py-4 ps-5">
            <div class="row">
                <div class="col">
                    <h1 class="display-3 font-title font-white fw-bold">Activities</h1>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 rounded-4 overflow-hidden h-100 bg-white shadow">
                        ...
                        <div class="card-body p-4 bg-white">
                            <h3 class="display-6 font-title text-dark mb-2"><?php echo $activityNames[$i]; ?></h3>
                            <p class="text-muted small mb-3 lh-base"><?php echo $activitySubtitles[$i]; ?></p>
                            <p class="small fw-semibold text-dark mb-0"><?php echo $activityHours[$i]; ?></p>
                        </div>
                    </div>
                </div>
            <?php endfor; ?>
        ...
        <div class="container">
            <div class="row align-items-center rounded-4 px-5 py-4 bg-lightbrown">
                ...
                <div class="col-lg-7 text-center text-lg-start mb-4 mb-lg-0">
                    <h2 class="h2 text-white fw-bold mb-3">Ready To Experience Timeless Elegance?</h2>
