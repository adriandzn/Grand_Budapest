...
<body class="bg-lightpink">
    ...
    <section class="hero-section text-white">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="hero-title font-title">Rooms</h1>
                    <p class="hero-subtitle">Accommodations</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="room-info">
                            ...
                            <h2 class="room-title font-title">Standard Room</h2>
                            ...
                            <p class="room-price mt-4">₱4,500.00 / night</p>
            ...
            <div class="room-card">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="room-info">
                            <h2 class="room-title font-title">Deluxe Room</h2>
                            ...
                            <p class="room-price mt-4">₱8,599.00 / night</p>
                ...
                <div class="row g-0 align-items-center">
                    <div class="col-lg-5">
                        <div class="room-info">
                            ...
                            <h2 class="room-title font-title">Suite Room</h2>
                            ...
                            <p class="room-price mt-4">₱14,999.00 / night</p>
